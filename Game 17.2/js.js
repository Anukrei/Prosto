...
function Images(arraY) {
  ...
  <div class="imagesBox">
    <img src="images/${arraY[10]}"class="imgItem" id= '${arraY[10]}' draggable="true" />
  </div>
</div>
  `;
}
  ...
  imagesCollectDone.forEach(() => {
    ...
    imagesItem.forEach((i, index) => {
      i.addEventListener("click", (e) => {
        ...
        if (e.target.id =='Page6.png'||e.target.id =='Page8.png'||e.target.id =='Page1.png'
        ||e.target.id =='Page2.png'||e.target.id =='Page3.png'||e.target.id =='Page12.png') {
