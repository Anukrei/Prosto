...
let count = 0;
let arr = ["aw1.mp3", "aw2.mp3", "aw3.mp3", "aw4.mp3","aw5.mp3","aw6.mp3"];
...
function Images(arraY) {
  ...
  <div class="boxImg"><img src="images/Page1.png" class='pro'id='aw2.mp3'> </div>
  <div class="boxImg"><img src="images/Page2.png" class='pro' id='aw5.mp3'class='pro' alt=""></div>

  <div class="boxImg"><img  src="images/Page3.png" class='pro' id='aw.mp3'alt=""></div>


  <div class="boxImg"><img src="images/Page4.png" class='pro' id='aw4.mp3'alt=""></div>  
  <div class="boxImg"><img src="images/Page5.png" class='pro' id='aw1.mp3'alt=""></div>
  
  
  <div class="boxImg"><img src="images/Page6.png" class='pro' id='aw1.mp3'alt=""></div>  
</div>
