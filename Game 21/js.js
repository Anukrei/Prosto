 ...
 console.log(res)
  res.forEach((i,index)=>{
   ...
   function dropFn1(e){
     ...
     console.log(item)
     if(item==='img2.png'||item==='img9.png'||item==='img7.png'||item==='img6.png'||item==='img1.png'){
      fnTrue()
      let a = e.target.id
      let ee = document.getElementById(item)
      ee.style.width = '100px'
      ee.style.height = '100px'
      ee.style.marginLeft = '35px'
   ...
   function dropFn6(e){
     let item = e.dataTransfer.getData('id')
     console.log(item)
     if(item==='img3.png'||item==='img4.png'||item==='img5.png'||item==='img8.png'){
      fnTrue()
      let a = e.target.id
      let ee = document.getElementById(item)
      ee.style.width = '100px'
