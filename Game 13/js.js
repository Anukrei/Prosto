 ...
 console.log(res)
  res.forEach((i,index)=>{
   ...
   function dropFn1(e){
     ...
     console.log(item)
     if(item==='img5.png'||item==='img1.png'||item==='img9.png'||item==='img2.png'){
      fnTrue()
      let a = e.target.id
      let ee = document.getElementById(item)
      ee.style.marginTop = '17px'
      ee.style.width = '90px'
      ee.style.height = '90px'
      ee.draggable = false
   ...
   function dropFn5(e){
     let item = e.dataTransfer.getData('id')
     console.log(item)
     if(item==='img3.png'||item==='img4.png'||item==='img6.png'||item==='img7.png'||item==='img8.png'){
      fnTrue()
      let a = e.target.id
      let ee = document.getElementById(item)
      ee.style.marginTop = '17px'
      ee.style.width = '60px'
      ee.style.height = '70px'
      e.target.append(document.getElementById(item))
      ee.draggable = false
     }else{
      fnFalse()
   ...
   function dropFn6(e){
     let item = e.dataTransfer.getData('id')
     console.log(item)
     if(item==='img4.png'||item==='img3.png'||item==='img6.png'||item==='img7.png'||item==='img8.png'){
      fnTrue()
      let a = e.target.id
      let ee = document.getElementById(item)
      ee.style.marginTop = '17px'
