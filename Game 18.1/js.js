  ...
  imagesCollectDone.forEach(() => {
    ...
    imagesItem.forEach((i, index) => {
      i.addEventListener("click", (e) => {
        ...
        if (e.target.id =='Page9.png'||e.target.id =='Page7.png'||e.target.id =='Page1.png'
        ||e.target.id =='Page6.png'||e.target.id =='Page11.png'||e.target.id =='Page10.png'||e.target.id =='Page4.png') {
